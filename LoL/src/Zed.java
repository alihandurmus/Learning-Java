public class Zed extends League{
    private String Ulti;
    ...
    public Zed(String Hero, int saldırıGucu, int yetenekGucu, String Ulti){
    ...
    public void bilgileriGoster() {
        ...
        System.out.println("Kahramanın pasif yeteneği : Düşene Tekme");
