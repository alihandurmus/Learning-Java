public class Riven extends League{
    private String Ulti;
    ...
    public Riven(String Hero, int saldırıGucu, int yetenekGucu, String Ulti){
    ...
    public void bilgileriGoster() {
        ...
        System.out.println("Kahramanın pasif yeteneği : Rünlü Kılıç");
